const multer = require('multer'); //middleware for files uploading
...
/* const multerStorage = multer.diskStorage({
    destination: (req, file, callbackFunc) => {
        callbackFunc(null, 'starter/public/img/users');
    },
    filename: (req, file, callbackFunc) => {
        //user-757fds8787fd5-223556435313.jpeg
...
const multerFilter = (req, file, callbackFunc) => {
    ...
    if (file.mimetype.startsWith('image')) {
        ...
        callbackFunc(new AppError('Not an image! Please upload only images.', 400), false);
    }
